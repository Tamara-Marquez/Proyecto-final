...
return (
    ...
    <div className="nav-logo">
        <Link to="/" onClick={closeMenu}>
            <span>
            {user?.id_rol === 1 ? "Panel Admin" : "VIP Concesionaria"}
            </span>
        </Link>
    </div>
    ...
    <ul className={`nav ${isMenuOpen ? "active" : ""}`}>
        ...
        <>
        <li className="nav_item">
                <Link to="/admin/nuevoproducto" onClick={closeMenu}>📑Nuevo producto</Link>
            </li>
            <li className="nav_item">
                <Link to="/admin/ventas" onClick={closeMenu}>💰 Ventas</Link>
            </li>
            <li className="nav_item nav_item-login">
                <button onClick={toggleProfile}>
                    👤 {user?.nombre?.split(" ")[0] || "Admi"}  ▼
                </button>
            <ul className={`sub_nav ${isProfileOpen ? "active" : ""}`}>
                <li>
                    <button
        ...
        <li className="nav_item has-submenu">
            ...
            <ul className={`sub_nav ${isCatalogOpen ? "active" : ""}`}>
                <li><Link to="/catalogo/autos" onClick={closeMenu}>🏎️ Autos</Link></li>
                <li><Link to="/catalogo/motos" onClick={closeMenu}>🛵 Motos</Link></li>
            </ul>
        </li>
